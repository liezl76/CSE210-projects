...
public class BreathingActivity : Activity
{
    ...
    public BreathingActivity(string activityName, string description, int duration, string breathInMessage, string breathOutMessage) : base(description, activityName, duration)
    {
